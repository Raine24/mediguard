      ...
      <main className="flex-grow flex items-center justify-center pt-32 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-xl w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
          <div className="bg-slate-900 px-8 py-10 text-center">
            ...
            <p className="text-slate-300">Join the MediGuard Affiliate Network and earn recurring revenue.</p>
          </div>
            ...
            {success ? (
              <div className="text-center">
                ...
                <p className="text-slate-600 mb-8">
                  Thank you for applying to become a MediGuard partner. Our team will review your application and notify you via email once approved.
                </p>
                <button 
                  onClick={() => router.push('/')}
              ...
              <form onSubmit={onSubmit} className="space-y-6">
                ...
                <div className="border-t border-slate-200 pt-6 mt-6">
                  ...
                  {/* Promotion Method */}
                  <div className="mb-6">
                    <label className="block text-sm font-medium text-slate-700 mb-1">How do you plan to promote MediGuard?</label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
