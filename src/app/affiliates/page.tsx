  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 font-sans">
      ...
      <main className="flex-grow">
        ...
        <div className="bg-slate-900 text-white pt-32 pb-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Partner with MediGuard</h1>
            <p className="text-xl md:text-2xl text-slate-300 mb-10">
              Join our affiliate program and earn a recurring 20% commission for every patient, family, or clinic you refer to MediGuard.
            </p>
            <Link 
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-10">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
                ...
                <p className="text-slate-600">By promoting MediGuard, you are helping patients take their medication on time. It's a product you can be proud to recommend.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-12">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-lg">Use our ready-made marketing materials to promote MediGuard to your audience via social media, blog posts, or directly to patients in clinics.</p>
                </div>
              </div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-8 text-center text-sm">
        <p>© {new Date().getFullYear()} MediGuard Affiliate Program. All rights reserved.</p>
      </footer>
    </div>
  );
}
