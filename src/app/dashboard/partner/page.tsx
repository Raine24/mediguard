...
import { DocumentDuplicateIcon, CheckCircleIcon, GiftIcon, CurrencyDollarIcon } from "@heroicons/react/24/outline";
          ...
          <div className="p-8 flex-1">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start">
                <CheckCircleIcon className="w-5 h-5 text-amber-500 mr-2 flex-shrink-0 mt-0.5" />
