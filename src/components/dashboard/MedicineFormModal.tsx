      ...
      <div className="bg-white rounded-2xl md:rounded-3xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/70 shrink-0">
          <div>
            ...
            <p className="text-xs text-gray-500 hidden sm:block">Set up your medication schedule and reminders</p>
          </div>
        ...
        <form id="medicine-form" onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all outline-none text-sm"
                    />
                  </div>
